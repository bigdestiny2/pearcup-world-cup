...
async function assertServedRuntimeContract (url, label) {
  ...
  for (const needle of ['runBootRuntimeSelfTest', 'runRuntimePeerHandshakeSelfTest', 'pearcupRuntimeSelfTestGuest', 'pearcup:runtime-self-test', 'PearCupPeerMatch.host()', 'avatars/p-aria.png', 'avatars/p-tariq.png', 'assets/mascot.png']) {
