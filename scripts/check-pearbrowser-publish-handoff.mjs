...
function validateSmokeContracts () {
  ...
  if (existsSync(runtimeSmokePath)) {
    ...
    for (const required of [
      ...
      'runtime self-test bracket activeScreen',
      'runtime self-test Bracket match cards',
      'runtime self-test Bracket pick buttons',
      'runtime self-test did not render generated avatar images in Bracket',
  ...
  if (existsSync(servedSmokePath)) {
    ...
    for (const required of [
      ...
      'Bracket route did not render generated avatar images',
      'runRuntimeHashRouteSelfTest',
      'Same-document hash route changes did not activate Bracket, Games, and Watch',
